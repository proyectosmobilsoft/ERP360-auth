...
export default (env, argv) => {
  ...
  return {
    entry: isStandalone
      ? "./client/src/standalone.tsx"
      : "./client/src/main.tsx", // Punto de entrada adaptado
    output: {
      filename: "sass-auth.js", // Nombre del microfrontend
    ...
    externals: isStandalone
      ? []
      : ["react", "react-dom", "single-spa", "single-spa-react"], // Dependencias compartidas solo en modo single-spa
    resolve: {
